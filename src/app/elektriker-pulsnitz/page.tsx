...
const local = getLocalLandingBySlug("elektriker-pulsnitz");
...
export default function ElektrikerPulsnitzPage() {
  return (
    <>
      <JsonLd id="elektriker-pulsnitz-schema" data={buildLocalLandingSchema(local)} />
      <JsonLd
        id="elektriker-pulsnitz-breadcrumb"
