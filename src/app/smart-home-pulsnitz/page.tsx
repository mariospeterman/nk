...
const local = getLocalLandingBySlug("smart-home-pulsnitz");
...
export default function SmartHomePulsnitzPage() {
  return (
    <>
      <JsonLd id="smart-home-pulsnitz-schema" data={buildLocalLandingSchema(local)} />
      <JsonLd
        id="smart-home-pulsnitz-breadcrumb"
